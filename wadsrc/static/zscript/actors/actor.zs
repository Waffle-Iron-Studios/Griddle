...
class Actor : Thinker native
{
	...
	native Actor A_SpawnProjectile(class<Actor> missiletype, double spawnheight = 32, double spawnofs_xy = 0, double angle = 0, int flags = CMF_TRACKOWNER, double pitch = 0, int ptr = AAPTR_TARGET);
